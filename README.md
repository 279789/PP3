...
<svg xmlns="http://www.w3.org/2000/svg"
  ...
  <desc>A simple example of an SVG file structure.</desc>
  <rect x="10" y="10" width="100" height="50" fill="blue" />
<line x1="10" y1="8" x2="110" y2="8" style="stroke:green;stroke-width:2" />
<circle r="20" cx="60" cy="35" fill="purple" />
<text x="22" y="6" width="200" height="50" fill="red">Hello there</text>
</svg>
    </code>
</details>
...
<details>
    ...
    They make the Written things that are in the same line behind Larger.
"1#" means very big "3 or or more "#" make the written stuff larger but not as big as 1#". 
</details>
<details>
    <summary>How do you mark italic or bold font?</summary>
    <code>
    **Bolded Text** *Italivized text*. For bolded Text use 2 Stars for and behind the Text.
 For Italivized text use 1 Star bevor and behind.
    </code>
</details>
<details>
...
<details>
  ...
  <li>Hello</li>
  <li>Salut</li>
  </ol>* You also could use *<ul>* Instead of ol if you don't wan't any numbers. 
...
td stands for table data, tr stands for table row, th stands for table header.
I think that the html code works on an "easy princeple", but it's very time consuming to build full documents.
I gues if you do it allday, you don't have to google everything like me and that would take much less time.
    </code>
</details>
